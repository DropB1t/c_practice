...
//Implementare una libreria per grafi.
//Struttura dati per memorizzare con liste di adiacenza
//funzioni di lettura e scrittura in file
//funzioni per visita dfs e bfs
//funzioni per controllare che non esistono cicli, che un grafo è conesso, che un grafo è un albero
